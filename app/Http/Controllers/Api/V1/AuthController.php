...
class AuthController extends Controller
{
        ...
        requestBody: new OA\RequestBody(
            ...
            content: new OA\JsonContent(
                ...
                properties: [
                    ...
                    new OA\Property(property: 'password', type: 'string', format: 'password', example: 'senha12345'),
                    new OA\Property(property: 'password_confirmation', type: 'string', format: 'password', example: 'senha12345'),
                ],
            ),
        ),
        responses: [
    ...
    #[OA\Post(
        ...
        responses: [
            new OA\Response(response: 200, description: 'Autenticado com sucesso', content: new OA\JsonContent(ref: '#/components/schemas/AuthResponse')),
            new OA\Response(response: 422, description: 'Credenciais inválidas', content: new OA\JsonContent(ref: '#/components/schemas/ValidationErrorResponse')),
        ],
    )]
    ...
    #[OA\Post(
        ...
        security: [['bearerAuth' => []]],
        responses: [
            new OA\Response(response: 200, description: 'Token renovado', content: new OA\JsonContent(ref: '#/components/schemas/AuthResponse')),
            new OA\Response(response: 401, description: 'Token inválido ou expirado', content: new OA\JsonContent(ref: '#/components/schemas/ErrorResponse')),
        ],
    )]
